...
func NewScraperService(redis *rds.Service) *ScraperService {
	return &ScraperService{log: logger.New("ScrapeService"), redis: redis, httpClient: newHTTPClient(), robots: robots.New()}
}

// ScrapeWithCache parity helper used by crawl: returns (result, cached, error)
func (s *ScraperService) ScrapeWithCache(ctx context.Context, url string, includeHTML, renderJs bool) (*engineapi.ScrapeResponse, bool, error) {
...
func (s *ScraperService) ScrapeURL(ctx context.Context, params engineapi.GetV1ScrapeParams) (*engineapi.ScrapeResponse, error) {
...
func (s *ScraperService) scrapeSimpleHTTP(params engineapi.GetV1ScrapeParams) (*engineapi.ScrapeResponse, error) {
...
func (s *ScraperService) scrapeWithPlaywright(params engineapi.GetV1ScrapeParams) (*engineapi.ScrapeResponse, error) {
...
func (s *ScraperService) convertHTMLToMarkdown(h string) string {
...
func (s *ScraperService) cleanContent(md string) string {
	if md == "" {
		return ""
	}
...
func (s *ScraperService) getCached(ctx context.Context, params engineapi.GetV1ScrapeParams) *engineapi.ScrapeResponse {
...
func (s *ScraperService) cache(ctx context.Context, params engineapi.GetV1ScrapeParams, res *engineapi.ScrapeResponse) {
	key := s.generateCacheKey(params)
...
func (s *ScraperService) generateCacheKey(params engineapi.GetV1ScrapeParams) string {
	render := "false"
	if params.RenderJs != nil && *params.RenderJs {
		render = "true"
	}
...
func (s *ScraperService) isRetryableScrapingError(err error) bool {
	if err == nil {
		return false
	}
...
func (s *ScraperService) isValidResult(res *engineapi.ScrapeResponse) bool {
	if res == nil {
		return false
	}
	content := ""
...
func (s *ScraperService) waitForDynamicContent(page playwright.Page, url string, waitSelectors []string) bool {
...
func (s *ScraperService) attemptDynamicContentWait(page playwright.Page, waitSelectors []string, initialSignature *ContentSignature) *ContentSignature {
	const (
...
func (s *ScraperService) chooseBestResult(results []StrategyResult, initial *ContentSignature) *StrategyResult {
...
func (s *ScraperService) getContentSignature(page playwright.Page) (*ContentSignature, error) {
...
func (s *ScraperService) hasSignificantContentChange(initial, final *ContentSignature, minChangeRatio float64) bool {
