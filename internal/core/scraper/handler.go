...
func NewScraperHandler(service *ScraperService, mapper *mapper.Service) *ScraperHandler {
	return &ScraperHandler{service: service, mapper: mapper}
}

func (h *ScraperHandler) HandleGetScrape(c *fiber.Ctx) error {
